...
export const getProjectJson = (projectName, author) => ({
    author,
    bugs: {
...
export const displayInstructions = () => {
    ...
    console.log(chalk.bold("Once you've done that, you're all set to start your project!\n"));
    console.log(chalk.green.bold("Run the following commands from the packages/react-app folder to start the project:\n"));
    console.log(chalk.yellow("   yarn install"));
    console.log(chalk.yellow("   yarn dev\n"));
    console.log(chalk.green("For detailed instructions on deploying the project using Vercel CLI, please refer to the Deployment Guide:"));
    console.log(chalk.blue("https://github.com/celo-org/celo-composer/blob/main/docs/DEPLOYMENT_GUIDE.md"));
    console.log(chalk.green("For adding UI components using ShadCN, please refer to the following guide:"));
    console.log(chalk.blue("https://github.com/celo-org/celo-composer/blob/main/docs/UI_COMPONENTS.md\n"));
    console.log(chalk.green("Thank you for using Celo Composer!") +
